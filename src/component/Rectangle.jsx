...
export default function Rectangle() {
  return (
    <div className="flex flex-col justify-center overflow-hidden items-center">
      ...
      <div class="max-w-4xl mx-6 md:h-48 h-36 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <img class="rounded-lg" src="/assets/kitchen1.jpg" alt="" />
      </div>
    </div>
  );
}
